        ...
        <section class="flat-spacing-25">
            <div class="container">
                <div class="tf-main-area-page tf-terms-conditions">
                    <div class="box">
                        <h4>Acceptance of Terms of Usage
                        </h4>
                        <p>These Terms of Usage govern your access and use of this Site. By accessing or using this Site you agree to be bound by these Terms of Usage and to any additional guidelines, restrictions, or rules that may be posted in connection with specific sections or services of this Site. All such additional posted guidelines, restrictions, or rules are hereby incorporated by reference into these Terms of Use.
                        </p>
                        <p>DX Prints reserves the right to make changes to this Site and to these Terms of Usage at any time without prior notice. You should review these Terms of Usage each time you access this Site.</p>
                        <p>You also agree that we may provide all legal communications and notices to you electronically by posting them on our website or, at our election, by sending an e-mail to the e-mail address you provided to us when you registered at our website. You may withdraw your consent to receive communications from us electronically by contacting customer care. However, if you withdraw your consent to receive our communications electronically, you must discontinue your use of your account.
                        </p>
                    </div>
                    <div class="box">
                        <h4>General
                        </h4>
                        <p>All the terms and conditions and/or any transactions occuring online at www.dxprints.my or by phone are subject to the laws of the State of Selangor.  DX Prints is not responsible for the delay and/or damages resulting from Machinery Breakdown, Acts of God, and from other actions, both governmental and otherwise, including but not limited to war, riot, seizure, and embargo. The Buyer's order shall be deemed an acceptance of the Seller's terms.  The Terms and conditions shall in all respects be governed by STATE OF SELANGOR law.</p>
                        <p>Note: Working Days EXCLUDE Public Holidays and Sunday.</p>
                        <p>Please Take note, due to the differences in monitor/screen, the final printing products may have a slight difference of +/-10% in terms of colours and brightness.</p>
                    </div>
                    <div class="box">
                        <h4>Reservations</h4>
                        <p>All orders are subject to acceptance by DX Prints. We reserve the right to reject any order at any time without recourse. We also reserve the right to change the price at any time even after we receive the order.
                        </p>
                    </div>
                    <div class="box">
                        <h4>Returns
                        </h4>
                        <p>Due to the nature of the product, no returns can be made once the order is processed and/or shipped. Any claims for defects, damages, or shortages must be made in writing within two (2) business days after receipt of the merchandise. We will replace only those orders that were processed incorrectly. The replacement of the order will take place only after the receipt of returned merchandise. We will not replace the order if it is determined by us that the order was misused or mishandle by the buyer or part of the order was used by the buyer and part of the order is being returned. 
                        </p>
                    </div>
                    <div class="box">
                        <h4>Unclaimed Items
                        </h4>
                        <p>Kindly be informed that any products remain uncollected for a period of one month will be disposed as per our policy.
                        </p>
                    </div>
                    <div class="box">
                        <h4>Credit Card
                        </h4>
                        <p>If the Buyer's credit card is declined, DX Prints will not process the Buyer’s order. If the order is shipped and should the Buyer's account become delinquent, Buyer agrees to pay a monthly finance charge of 2% (annual percentage rate of 24%) on the unpaid balance. If an account goes beyond the payment term's due date, unless specific arrangements are made, future purchases will require advance payment. In the event that DX Prints must commence legal action to enforce any terms of this agreement, the Buyer agrees to pay reasonable legal fees and costs.</p>
                    </div>
                    <div class="box">
                        <h4>Warranty
                        </h4>
                        <p>DX Prints neither makes any explicit warranty nor imply or accepts any responsibility other than possible replacement of the products that Buyer is buying.  DX Prints may but does not guarantee the replacement of the defective product, or credit the amount of the purchase price. 
                        </p>
                    </div>
                    <div class="box">
                        <h4>Shipping
                        </h4>
                        <p>Shipping terms are F.O.B. which can be describe as the point at which the seller (DX Prints) is no longer responsible for shipping cause.  DX Prints will arrange for shipping with the carrier on behalf of the buyer.  The Buyer will be fully responsible for the shipping and handling cost.  DX Prints will not be responsible for the delay in delivery, loss or damage of the order while the order is with the shipping carrier.
                        </p>
                    </div>
                    <div class="box">
                        <h4>Limitation of Liability
                        </h4>
                        <p>DX Prints will not be liable in contract or in tort (including negligence) to the customer for incidental or consequential damages, arising out of or resulting from anybody’s performance or nonperformance of our obligations.  DX Prints shall not be liable to anyone for any kind of financial losses, cost, expenses, damages and/or other economic damages.  The Buyer agrees that the Buyer will not hold DX Prints responsible for any and all loss, cost, expense, and damages (including legal costs) on account of any and all manner of claims, demands, actions, and proceedings that may be instituted against DX Prints and its affiliated company (S) on grounds alleging that the said work violates any copyrights, trademarks, service marks, or is scandalous, or invades any person's right to privacy or other personal rights.</p>
                        
                    </div>
                    <div class="box">
                        <h4>Cancellations and Refunds
                        </h4>
                        <p>DX Prints and its affiliated company will not refund any money for the orders that were shipped or were cancelled after the order was being processed.
                        </p>
                    </div>
                    <div class="box">
                        <h4>
                        ...
                        <p>DX Prints hereby declared that we produce and print HALAL RELATED items only. Non-halal items such as liquors, gambling materials, non-halal meats, alcohol related event and other related products/events will not be produced and printed. Religious products are subjected to DX Prints approval.
                        </p>
                        <p>DX Prints will not print any form of material that is defamatory or defames any person or organization
    </p>        
                    </div>
                    <div class="box">
                        <p>Copyright Act 1987:                 
                        </p>
                        <p>Unauthorized photocopying of book is illegal under the Copyright Act 1987 (Copyright Act)
                    </div>
                </div>
            </div>
        </section>
