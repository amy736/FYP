                                ...
                                <div class="footer-infor">
                                    ...
                                    <ul>
                                        <li>
                                            <p><b>DXPRINT</b></p>
                                        <li>
                                            <p>134 Jalan Jejaka Taman Maluri,</p>
                                        </li>
                                        <li>
                                            <p>55100 Cheras, Kuala Lumpur</p>
                                        </li>
                                    </ul>
                                    <!-- <a href="contact-1.html" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a> -->
                                    <ul class="tf-social-icon d-flex gap-10">
                                        <li><a href="https://www.facebook.com/kedaiuniformsekolah/videos/?_rdr" class="box-icon w_34 round social-facebook social-line" target="_blank"><i class="icon fs-14 icon-fb"></i></a></li>
                                        <!-- <li><a href="#" class="box-icon w_34 round social-twiter social-line"><i class="icon fs-12 icon-Icon-x"></i></a></li> -->
                                        <li><a href="https://www.instagram.com/dxprints/?igsh=MWszbGM4dXd1cnZwOA%3D%3D" class="box-icon w_34 round social-instagram social-line" target="_blank"><i class="icon fs-14 icon-instagram"></i></a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                                    <div class="footer-menu_item">© 2024 DXPRINT. All Rights Reserved</div>
