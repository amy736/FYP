                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="<?=base_url();?>" class="logo-header">
                            <!-- <img src="assets\images\homepage\logo.jpg" alt="logo" class="logo dark-logo"> -->
                            <h5><b>DXPRINT</b></h5>
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            ...
                            <div class="box-content text-center">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1 text-stroke-white heading font-caprasimo">DXPRINT</h1>
                                    <p class="fade-item fade-item-2 text_white d-block font-caprasimo">collections</p>
                                    <div class="fade-item fade-item-3">
                                        <a href="<?=base_url('main/shopNow')?>" class="tf-btn btn-light-icon font-caprasimo fw-4 animate-hover-btn letter-2"><span>SHOP NOW</span></a> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div dir="ltr" class="swiper tf-sw-collection" data-preview="3" data-tablet="2" data-mobile="2" data-space-lg="30" data-space-md="30" data-space="15" data-loop="false" data-auto-play="false">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="<?=base_url('main/shobyCategory/1')?>" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets\images\homepage\58176218_o.jpg" src="<?= base_url();?>assets\images\homepage\58176218_o.jpg" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                                <a href="<?=base_url('main/shobyCategory/1')?>" class="tf-btn collection-title hover-icon fs-15"><span>Long Sleeve</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="<?=base_url('main/shobyCategory/2')?>" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets\images\homepage\26b5992756bc8e97f4c12837bd0dbe8f.jpg" src="<?= base_url();?>assets\images\homepage\26b5992756bc8e97f4c12837bd0dbe8f.jpg" alt="collection-img">
                                            </a>
                                            <div class="collection-content">
                                                <a href="<?=base_url('main/shobyCategory/2')?>" class="tf-btn collection-title hover-icon fs-15"><span>Short Sleeve</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="<?=base_url('main/shobyCategory/3')?>" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets\images\homepage\14.jpg" src="<?= base_url();?>assets\images\homepage\14.jpg" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                                <a href="<?=base_url('main/shobyCategory/3')?>" class="tf-btn collection-title hover-icon fs-15"><span>Others</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="<?=base_url('main/shobyCategory/4')?>" class="collection-image img-style">
                                                <img class="lazyload" data-src="<?= base_url();?>assets\images\homepage\download.jpg" src="<?= base_url();?>assets\images\homepage\download.jpg" alt="collection-demo-1">
                                            </a>
                                            <div class="collection-content">
                                                <a href="<?=base_url('main/shobyCategory/4')?>" class="tf-btn collection-title hover-icon fs-15"><span>Uniform</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="flat-spacing-5 pt_0 flat-testimonial">
            <div class="container">
                <div class="flat-title wow fadeInUp" data-wow-delay="0s">
                    <span class="title">What We Offer</span>
                    <p class="sub-title">Turning your ideas into reality</p>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item style-column wow fadeInUp" data-wow-delay="0s">
                                    ...
                                    <div class="heading">Custom Your Own Design</div>
                                    <div class="text">
                                        We offer a wide range of customizable products designed to suit every need. From fashionable custom apparel like t-shirts, tote bag, name tag, and banner.
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-column wow fadeInUp" data-wow-delay=".1s">
                                    ...
                                    <div class="text">
                                        At the heart of our offerings is a commitment to selection and quality. We utilize advanced printing techniques to ensure your designs are vibrant, durable, and exactly as you envision.
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-column wow fadeInUp" data-wow-delay=".2s">
                                    ...
                                    <div class="heading">Seamless Customization Experience</div>
                                    <div class="text">
                                        With options ranging from vibrant digital printing to durable embroidery and eco-friendly materials, we're committed to delivering products that match your vision and values.
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-column wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div class="heading">Simple & Intuitive Process</div>
                                    <div class="text">
                                        We pride ourselves on using advanced printing technologies and quality materials, ensuring every product not only looks great but lasts.
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="tf-login-form">
                    <form class="" action="<? echo base_url('login/register'); ?>" accept-charset="utf-8" method="post">
                        ...
                        <div class="tf-field style-1">
                            <input class="tf-field-input tf-input" required placeholder=" " type="text"  name="phone_no">
