        ...
        <section class="flat-spacing-11">
            <div class="container">
                <div class="tf-accordion-wrap d-flex justify-content-between">
                        ...
                        <div class="tf-accordion-link-list w-100 sticky-top radius-10 border-line">
                            <div class="tf-link-item">
                                <a class="d-flex justify-content-between align-items-center line" href="#shopping-information">
                                    <h6 class="fw-5">Online Printing System</h6>
                            ...
                            <div class="tf-link-item">
                                <a class="d-flex justify-content-between align-items-center line" href="#payment-information">
                                    <h6 class="fw-5">Products</h6>
                                    <div class="icon"><i class="icon-arrow1-top-left"></i></div>
                                </a>
                            </div>
                            <div class="tf-link-item">
                                <a class="d-flex justify-content-between align-items-center line" href="#order-returns">
                                    <h6 class="fw-5">Printing</h6>
                                    <div class="icon"><i class="icon-arrow1-top-left"></i></div>
                                </a>
                            </div>
                            <div class="tf-link-item">
                                <a class="d-flex justify-content-between align-items-center line" href="#order-pricing">
                                    <h6 class="fw-5">Pricing</h6>
                                    <div class="icon"><i class="icon-arrow1-top-left"></i></div>
                                </a>
                            </div>
                            <div class="tf-link-item">
                                <a class="d-flex justify-content-between align-items-center line" href="#order-paymeny">
                                    <h6 class="fw-5">Payment</h6>
                                    <div class="icon"><i class="icon-arrow1-top-left"></i></div>
                                </a>
                            </div>
                            <div class="tf-link-item">
                                <a class="d-flex justify-content-between align-items-center" href="<?=base_url('main/contactUs')?>">
                    ...
                    <div class="content">
                        <h5 id="shopping-information" class="mb_24">Online Printing System</h5>
                        <div class="flat-accordion style-default has-btns mb_60">
                            <div class="flat-toggle active">
                                <div class="toggle-title active">What is Online Printing System?</div>
                                <div class="toggle-content">
                                    <p>Online Printing System is a prepress process that bridges the gap between online digital content and commercial print production.</p>
                                </div>
                            </div>
                            <div class="flat-toggle">
                                <div class="toggle-title">How does it help my print business?</div>
                                <div class="toggle-content">
                                    <p>This solution will make your company run more efficiently and profitably by streamlining your business processes, maximizing your resources and eliminating redundant operations.</p>
                                </div>
                            </div>
                        </div>
                        <h5 id="payment-information" class="mb_24">Products</h5>
                        <div class="flat-accordion style-default has-btns mb_60">
                            <div class="flat-toggle">
                                <div class="toggle-title">How many products does your site support?</div>
                                <div class="toggle-content">
                                    <p>The site currently supports five major and popular print products as listed. We are shortly going to introduce more products like banners, nametag, vest, tote bag & clothes.</p>
                                </div>
                            </div>
                            <div class="flat-toggle">
                                <div class="toggle-title">What options are available for product design?</div>
                                <div class="toggle-content">
                                    <p>There are three options for designing and customizing a product. Click a product on the left-hand panel and choose one of the options.</p>
                                    <br><br>
                                    <b>
                                    <ol>
                                        <li>1.Select the design that user want.</li>
                                        <li>2.User can add to cart and inform to WhatsApp to make an order.</li>
                                        <li>3.Make a payment.</li>
                                    </ol>
                                </b>
                                </div>
                            </div>
                        </div>
                        <h5 id="order-returns" class="mb_24">Printing</h5>
                        <div class="flat-accordion style-default has-btns">
                            <div class="flat-toggle">
                                <div class="toggle-title">What color formats are supported by your site?</div>
                                <div class="toggle-content">
                                    <p>Our system supports RGB (red, green, blue) for producing digital prints. We have accurately mapped color pallet to match RGB to CMYK (cyan, magenta, yellow, key) to ensure proper 4-color printing.</p>
                                </div>
                            </div>
                            <div class="flat-toggle">
                                <div class="toggle-title">What printing method do you use?</div>
                                <div class="toggle-content">
                                    <p>We use offset printing, which provides the highest quality of print material for both text and images.</p>
                                </div>
                            </div>
                            <div class="flat-toggle">
                                <div class="toggle-title">What is the resolution of output file?</div>
                                <div class="toggle-content">
                                    <p>300 dpi (dots per inch) is the resolution of the output PDF file.</p>
                                </div>
                            </div>
                        </div>
                        <br><br>
                        <h5 id="order-pricing" class="mb_24">Pricing</h5>
                        <div class="flat-accordion style-default has-btns">
                            <div class="flat-toggle">
                                <div class="toggle-title">Are the prices listed on the site final? How do I know the total cost?</div>
                                <div class="toggle-content">
                                    <p>No, the price list indicates basic prices of products against the speculative quantities. The prices are calculated with regard to the most basic paper/card types, sizes and single side printing. As you know, the final printing cost depends on many parameters: 2 or 4 colors, square or rounded corners, single or double side printing, quantity, destination shipping charges and the mode of transport. Please use the indicative prices for calculating the basic cost. Once you place the order using the above parameters, we will quickly mail you the final, exact cost.</p>
                                </div>
                            </div>
                            
                        </div>
                        <br><br>
                        <h5 id="order-paymeny" class="mb_24">Payment</h5>
                        <div class="flat-accordion style-default has-btns">
                            <div class="flat-toggle">
                                <div class="toggle-title">Can Make the Payment in Cash?</div>
                                <div class="toggle-content">
                                    <p>Yes, but we accept cash payment in store.</p>
                                </div>
                            </div>
